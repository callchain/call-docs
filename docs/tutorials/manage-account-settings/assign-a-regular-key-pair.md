...
{
  "result": {
    "account_id": "csprUqu6BHAffAeG4HpSdjBNvnA6gdnZV7",
    "key_type": "secp256k1",
...
```
{
  ...
  "tx_json": {
      ...
      "account": "cUAi7pipxGpYfPNg3LtPcf2ApiS8aw9A93",
      "RegularKey": "csprUqu6BHAffAeG4HpSdjBNvnA6gdnZV7"
      },
...
calld sign ssCATR7CBvn4GLd1UuU2bqqQffHki '{"TransactionType": "SetRegularKey", "account": "cUAi7pipxGpYfPNg3LtPcf2ApiS8aw9A93", "RegularKey": "csprUqu6BHAffAeG4HpSdjBNvnA6gdnZV7"}'
```
...
calld submit 
```
...
```
#Syntax: sign secret tx_json
calld sign sh8i92YRnEjJy3fpFkL8txQSCVo79 '{"TransactionType": "AccountSet", "account": "cUAi7pipxGpYfPNg3LtPcf2ApiS8aw9A93"}'
```
...
```
#Syntax: submit tx_blob
calld submit 
```
...
- [List CALL as an Exchange](list-call-as-an-exchange.html)

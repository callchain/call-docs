# fetch_info
[[Source]<br>](https://github.com/callchain/call-lib/blob/315a8b6b602798a4cff4d8e1911936011e12abdb/src/call/rpc/handlers/FetchInfo.cpp "Source")
...
_The `fetch_info` method is an [admin method](admin-calld-methods.html) that cannot be run by unprivileged users._

# account_tx
[[Source]<br>](https://github.com/callchain/call-lib/blob/master/src/call/rpc/handlers/AccountTx.cpp "Source")
...
calld -- account_tx cDVCAS1cnoMboELkQXxdmhJCiMscMm93U2 -1 -1 2 5 1 0 1
```
...
[[Source]<br>](https://github.com/callchain/call-lib/blob/master/src/call/rpc/handlers/AccountTxSwitch.cpp "Source")<br>
...
* `actBitcoin` - The [Address][] specified in the `account` field is formatted like a Bitcoin address instead of a CALL Ledger address.

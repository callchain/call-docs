# sign_for
[[Source]<br>](https://github.com/callchain/call-lib/blob/release/src/call/rpc/handlers/SignFor.cpp "Source")
...
This command requires the [MultiSign amendment][] to be enabled. [New in: calld 0.31.0][]
...
```
#Syntax: calld sign_for <signer_address> <signer_secret> [offline]
calld sign_for rsA2LpzuawewSBQXkiju3YQTMzW13pAAdW s████████████████████████████ '{
    "TransactionType": "TrustSet",
    "account": "cEuLyBCvcw4CFmzv8RepSiAoNgF8tTGJQC",
    "Flags": 262144,
    "LimitAmount": {

# tx
[[Source]<br>](https://github.com/callchain/call-lib/blob/master/src/call/rpc/handlers/Tx.cpp "Source")
...
calld tx E08D6E9754025BA2534A78707605E0601F03ACE063687A0CA1BDDACFCD1698C7 false
```
...
```
{
    ...
    "result": {
        ...
        "Destination": "cDVCAS1cnoMboELkQXxdmhJCiMscMm93U2",
        "Fee": "10",
        "Flags": 0,
        "Paths": [
            [
...
* `txnNotFound` - Either the transaction does not exist, or it was part of an older ledger version that `calld` does not have available.

# DepositPreauth
[[Source]<br>](https://github.com/callchain/call-lib/blob/master/src/call/app/tx/impl/DepositPreauth.cpp "Source") <!--{# TODO: change from develop to master when 1.1.0 is released #}-->
...
```json
{
  ...
  "Authorize" : "cEhxGqkqPPSxQ3P25J66ft5TwpzV14k2de",
  "Fee" : "10",
  "Flags" : 2147483648,
  "Sequence" : 2
}
...
|:--------------|:----------|:------------------|:-----|
| `Authorize`   | String    | AccountID         | _(Optional)_ The CALL Ledger address of the sender to preauthorize. |
| `Unauthorize` | String    | AccountID         | _(Optional)_ The CALL Ledger address of a sender whose preauthorization should be revoked. |

# SignerListSet
[[Source]<br>](https://github.com/callchain/call-lib/blob/ef511282709a6a0721b504c6b7703f9de3eecf38/src/call/app/tx/impl/SetSignerList.cpp "Source")

The SignerListSet transaction creates, replaces, or removes a list of signers that can be used to [multi-sign](multi-signing.html) a transaction. This transaction type was introduced by the [MultiSign amendment][]. [New in: calld 0.31.0][]

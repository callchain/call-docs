# print
[[Source]<br>](https://github.com/callchain/call-lib/blob/315a8b6b602798a4cff4d8e1911936011e12abdb/src/call/rpc/handlers/Print.cpp "Source")
...
*The `print` method is an [admin method](admin-calld-methods.html) that cannot be run by unprivileged users!*
...
The response follows the [standard format][]. Additional fields in the result depend on the internal state of the `calld` server. The results of this command are subject to change without notice.
